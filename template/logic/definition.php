...
$html->core_logic_rules = [
  ...
  [ 'name' => 'user',
    'label' => 'User',
    'operands' => [
      [ 'name' => 'exists', 'label' => 'exists (logged-in)', 'value' => false ],
      [ 'name' => 'not_exists', 'label' => 'does not exist (not logged-in)', 'value' => false ],
    ],
  ],
  [ 'name' => 'user_field',
    'label' => 'User field',
  ...
  [ 'name' => 'archive',
    ...
    'field_2' => [ 'type' => 'string', 'default' => 'post' ],
  ],

 ...
 *
 * Changes - Search for keyword "// Tangible"
 *
 * - Added: Dynamic importer
 * - Added: Add public function resetVariables
 */
...
class Compiler
{
    ...
    // Tangible: ADDED
    protected $dynamicImporter = null;
    protected $exitDynamicImporter = null;

    protected $userFunctions = [];

    // Tangible: CHANGED - Was protected
    ...
    /**
     * @var string|\Tangible\ScssPhp\Formatter
     */
    protected $formatter = 'Tangible\ScssPhp\Formatter\Nested';
     ...
     * @param string $path
     *
     * @return \Tangible\ScssPhp\Parser
     */
     ...
     *
     * @return \Tangible\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \Tangible\ScssPhp\Block $rootBlock
     */
     ...
     * Flatten selectors
     *
     * @param \Tangible\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \Tangible\ScssPhp\Block $media
     */
     ...
     * Media parent
     *
     * @param \Tangible\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \Tangible\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile directive
     *
     * @param \Tangible\ScssPhp\Block $block
     */
     ...
     * @param integer $without
     *
     * @return \Tangible\ScssPhp\Compiler\Environment
     */
     ...
     *
     * @param array                                $stms
     * @param \Tangible\ScssPhp\Formatter\OutputBlock $out
     *
     * @return array
     */
    ...
    protected function compileImport($rawPath, $out, $once = false)
    {
        if ($rawPath[0] === Type::T_STRING) {
            ...
            // Dynamic import, similar to $this->importFile

            $code = $this->dynamicImport($path);
     ...
     * @param boolean $inExp
     *
     * @return array|\Tangible\ScssPhp\Node\Number
     */
     ...
     * @param array $right
     *
     * @return \Tangible\ScssPhp\Node\Number
     */
     ...
     *
     * @param \Tangible\ScssPhp\Compiler\Environment $env
     *
     * @return array
     */
    ...
    // Tangible: ADDED
    public function resetVariables(array $variables = [])
    {
    ...
    public function setDynamicImporter($fn) {
        $this->dynamicImporter = $fn;
    }

    protected function dynamicImport($path) {
        if ($this->dynamicImporter) {
            $fn = $this->dynamicImporter;
            return $fn($path);
        }
        return false;
    }

    public function setExitDynamicImporter($fn) {
      $this->exitDynamicImporter = $fn;
    }

    protected function exitDynamicImport($path) {
        if ($this->exitDynamicImporter) {
            $fn = $this->exitDynamicImporter;
            return $fn($path);
        }
    }
     ...
     *
     * @return \Tangible\ScssPhp\Compiler
     */
     ...
     *
     * @throws \Tangible\ScssPhp\Exception\CompilerException
     */

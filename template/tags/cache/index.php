...
$html->cache_tag = function($atts, $nodes) use ($html) {
  ...
  if (count($expire) > 1) {
    ...
    switch ($expire[1]) {
      case 'minute':
      case 'minutes': $expire_seconds *= 60; break;
      case 'hours':
      case 'hour': $expire_seconds *= 60 * 60; break;
      case 'days':
      case 'day': $expire_seconds *= 60 * 60 * 24; break;
      case 'months':
      case 'month': $expire_seconds *= 60 * 60 * 24 * 30; break;
      case 'years':
      case 'year': $expire_seconds *= 60 * 60 * 24 * 30 * 365; break;
    }
  }

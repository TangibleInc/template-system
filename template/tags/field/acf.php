...
$html->get_acf_field_type = function($acf_field_type, $field_name, $options = []) use ($loop, $html) {
  ...
  switch ($acf_field_type) {
    case 'editor':    $acf_field_type = 'wysiwyg'; break;
    case 'post':      $acf_field_type = 'post_object'; break;
    case 'flexible':  $acf_field_type = 'flexible_content'; break;
    case 'date':      $acf_field_type = 'date_picker'; break;
    case 'date_time': $acf_field_type = 'date_time_picker'; break;
    case 'time':      $acf_field_type = 'time_picker'; break;
  }
  ...
  switch ($acf_field_type) {
    ...
    case 'date_time_picker': return $value; // Default format "Y-m-d H:i:s"
    case 'time_picker': return $value;

...
class CalendarDayLoop extends BaseLoop {
  ...
  function get_item_field( $item, $field_name, $args = [] ) {
    ...
    switch ($field_name) {
      ...
      case 'name': return $item->format('l');
      case 'short_name': return $item->format('D');

      case 'year': return $item->format('Y');

      case 'month': return $item->format('n');
      case 'month_with_zero': return $item->format('m');

      case 'day': return $item->format('j');
      case 'day_with_zero': return $item->format('d');

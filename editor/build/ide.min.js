(function () {
    ...
    __name$B(Orientation, "Orientation");
    Orientation.HORZ = new _Orientation("horz");
    Orientation.VERT = new _Orientation("vert");
    ...
    __name$z(DockLocation, "DockLocation");
    DockLocation.values = {};
    DockLocation.TOP = new _DockLocation("top", Orientation.VERT, 0);
    DockLocation.BOTTOM = new _DockLocation("bottom", Orientation.VERT, 1);
    DockLocation.LEFT = new _DockLocation("left", Orientation.HORZ, 0);
    DockLocation.RIGHT = new _DockLocation("right", Orientation.HORZ, 1);
    DockLocation.CENTER = new _DockLocation("center", Orientation.VERT, 0);

    var __defProp$y = Object.defineProperty;
    var __name$y = (target, value) => __defProp$y(target, "name", { value, configurable: true });
    const canUseDOM = !!(typeof window !== "undefined" && window.document && window.document.createElement);
    const _DragDrop = class {
      /** @internal */
      constructor() {
        /** @internal */
    ...
    __name$y(DragDrop, "DragDrop");
    DragDrop.instance = new _DragDrop();
    ...
    __name$u(AttributeDefinitions, "AttributeDefinitions");
    ...
    const _SplitterNode = class extends Node {
      /** @internal */
      constructor(model) {
        super(model);
        this._fixed = true;
    ...
    __name$q(TabNode, "TabNode");
    TabNode.TYPE = "tab";
    /** @internal */
    TabNode._attributeDefinitions = _TabNode._createAttributeDefinitions();

    var __defProp$p = Object.defineProperty;
    var __name$p = (target, value) => __defProp$p(target, "name", { value, configurable: true });
    const _RowNode = class extends Node {
      /** @internal */
    ...
    __name$p(RowNode, "RowNode");
    RowNode.TYPE = "row";
    /** @internal */
    RowNode._attributeDefinitions = _RowNode._createAttributeDefinitions();

    var __defProp$o = Object.defineProperty;
    var __name$o = (target, value) => __defProp$o(target, "name", { value, configurable: true });
    const _TabSetNode = class extends Node {
      /** @internal */
      constructor(model, json) {
        super(model);
    ...
    __name$o(TabSetNode, "TabSetNode");
    TabSetNode.TYPE = "tabset";
    /** @internal */
    TabSetNode._attributeDefinitions = _TabSetNode._createAttributeDefinitions();
    ...
    const _BorderNode = class extends Node {
      /** @internal */
    ...
    __name$m(BorderNode, "BorderNode");
    BorderNode.TYPE = "border";
    /** @internal */
    BorderNode._attributeDefinitions = _BorderNode._createAttributeDefinitions();
    ...
    __name$e(ErrorBoundary, "ErrorBoundary");
    ...
    class Layout extends wp.element.Component {
      constructor(props) {
        ...
        /** @internal */
        this.onModelChange = /* @__PURE__ */ __name$6((action) => {
          this.forceUpdate();
        ...
        /** @internal */
        this.updateRect = /* @__PURE__ */ __name$6((domRect = this.getDomRect()) => {
        ...
        /** @internal */
        this.updateLayoutMetrics = /* @__PURE__ */ __name$6(() => {
        ...
        /** @internal */
        this.getClassName = /* @__PURE__ */ __name$6((defaultClassName) => {
        ...
        /** @internal */
        this.onCloseWindow = /* @__PURE__ */ __name$6((id) => {
        ...
        /** @internal */
        this.onSetWindow = /* @__PURE__ */ __name$6((id, window2) => {
          this.props.model.getNodeById(id)._setWindow(window2);
        }, "onSetWindow");
        /** @internal */
        this.onCancelAdd = /* @__PURE__ */ __name$6(() => {
        ...
        /** @internal */
        this.onCancelDrag = /* @__PURE__ */ __name$6((wasDragging) => {
          if (wasDragging) {
            const rootdiv = this.selfRef.current;
            try {
        ...
        /** @internal */
        this.onDragDivMouseDown = /* @__PURE__ */ __name$6((event) => {
          event.preventDefault();
          this.dragStart(event, this.dragDivText, TabNode._fromJson(this.newTabJson, this.props.model, false), true, void 0, void 0);
        }, "onDragDivMouseDown");
        /** @internal */
        this.dragStart = /* @__PURE__ */ __name$6((event, dragDivText, node, allowDrag, onClick, onDoubleClick) => {
          if (!allowDrag) {
        ...
        /** @internal */
        this.dragRectRender = /* @__PURE__ */ __name$6((text, node, json, onRendered) => {
          let content;
          if (text !== void 0) {
        ...
        /** @internal */
        this.showPortal = /* @__PURE__ */ __name$6((control, element) => {
          const portal = wp.element.createPortal(control, element);
          this.setState({ portal });
        }, "showPortal");
        /** @internal */
        this.hidePortal = /* @__PURE__ */ __name$6(() => {
          this.setState({ portal: void 0 });
        }, "hidePortal");
        /** @internal */
        this.onDragStart = /* @__PURE__ */ __name$6(() => {
        ...
        /** @internal */
        this.onDragMove = /* @__PURE__ */ __name$6((event) => {
        ...
        /** @internal */
        this.onDragEnd = /* @__PURE__ */ __name$6((event) => {
          const rootdiv = this.selfRef.current;
          rootdiv.removeChild(this.outlineDiv);
          rootdiv.removeChild(this.dragDiv);
          this.dragDiv = void 0;
    ...
    let Model = _Model;
    __name$4(Model, "Model");
    /** @internal */
    Model._attributeDefinitions = _Model._createAttributeDefinitions();
    ...
    jQuery(document).ready(function($) {
      ...
      const root = wp.element.createRoot(ideElement);
      const templatePost = {
      ...
      root.render(/* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(Header, { layoutModel, ideElement }), /* @__PURE__ */ wp.element.createElement("div", { className: "ide-main" }, /* @__PURE__ */ wp.element.createElement(
        Layout,
        {
          model: layoutModel,

...
use Tangible\Symfony\Component\Config\Resource\FileResource;
use Tangible\Symfony\Component\Config\Util\XmlUtils;
...
class XliffFileLoader implements LoaderInterface
{
    ...
    public function load($resource, string $locale, string $domain = 'messages')
    {
        ...
        if (class_exists('Tangible\\Symfony\Component\Config\Resource\FileResource')) {

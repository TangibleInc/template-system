...
class Carousel extends BaseComponent {
  ...
  _setActiveIndicatorElement(index) {
    ...
    const newActiveIndicator = SelectorEngine.findOne(`[data-${DATA_PREFIX}slide-to="${index}"]`, this._indicatorsElement)
  ...
  _updateInterval() {
    ...
    const elementInterval = Number.parseInt(element.getAttribute(`data-${DATA_PREFIX}interval`), 10)

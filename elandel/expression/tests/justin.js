      ...
      : (unary(op, prec),
        operator(
          ...
          (a, b) =>
            !b &&
            ((a = compile(a)),
            !a.length ? ((a = fn(a())), () => a) : (ctx) => fn(a(ctx))),
        ))
...
test('justin: Uncompleted expression-call/array', () => {
  ...
  throws(
    () => console.log(justin('myFunction(a,b')),
...
test('justin: Esprima Comparison', () => {
  ...
  is(
    justin("$foo[ bar][ baz].other12 ['lawl'][12]")({
      $foo: [[, { other12: { lawl: { 12: 'abc' } } }]],
      bar: 0,
      baz: 1,
    }),
    'abc',
  ...
  is(
    justin('$foo     [ 12  ] [ baz[z]    ].other12*4 + 1 ')({
      $foo: { 12: [, { other12: 2 }] },
      baz: [, 1],
      z: 1,
    }),
  ...
  is(
    justin("$foo[ bar][ baz]    (a, bb ,   c  )   .other12 ['lawl'][12]")({
      $foo: [[, (a, b, c) => ({ other12: { lawl: { 12: a + b + c } } })]],
      a: 1,
      bb: 2,
      c: 3,
      bar: 0,
  ...
  is(justin('(((1)))')(), 1)
  is(
    justin('(Object.variable.toLowerCase()).length == 3')({

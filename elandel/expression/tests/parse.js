...
test('parse: basic', (t) => {
  ...
  is(parse(`a (  ccc. d,  -+1.0 )`), [
    '()',
    'a',
    [',', ['.', 'ccc', 'd'], ['-', ['+', ['', 1]]]],
  ])
  is(parse(`(a + 2) * 3 / 2 + b * 2 - 1`), [
    '-',
    [
      '+',
      ['/', ['*', ['()', ['+', 'a', ['', 2]]], ['', 3]], ['', 2]],
